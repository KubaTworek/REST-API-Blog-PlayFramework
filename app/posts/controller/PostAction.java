...
import comments.controller.CommentAction;
...
public class PostAction extends Action.Simple {
    ...
    @Inject
    public PostAction(MetricRegistry metrics, HttpExecutionContext httpExecutionContext, Futures futures) {
